...
export function HerMemories() {
    ...
    return (
        <section
            ref={containerRef}
            className="relative min-h-[150vh] w-full bg-[#1A120B] overflow-hidden py-32 px-6"
        >
            {/* Dynamic light */}
                    ...
                    {PHOTOS.map((src, i) => {
                        ...
                        return (
                            <div
                                ...
                                className={`absolute ${positions[i % positions.length]} group cursor-pointer hover:z-50 transition-all duration-500`}
                                style={{ zIndex: i + 10 }}
                            >
                                        ...
                                        <img
                                            ...
                                            onError={(e) => {
                                                ...
                                                e.currentTarget.parentElement!.innerHTML =
                                                    '<div class="w-full h-full aspect-[4/5] bg-gradient-to-br from-[#e0d3c1] to-[#cfc4b4] flex items-center justify-center text-deep-brown font-serif text-sm">Foto</div>';
                                            }}
                                        />
                                    </div>
