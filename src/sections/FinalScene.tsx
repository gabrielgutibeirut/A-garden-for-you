...
export function FinalScene() {
    ...
    return (
        <section
            ref={containerRef}
            className="relative h-screen w-full bg-subtle-black overflow-hidden flex items-center justify-center"
        >
            ...
            <div className="relative z-30 w-full max-w-4xl px-6 text-center space-y-24">
                ...
                <div
                    ref={msgTextRef}
                    className="absolute inset-0 flex items-center justify-center w-full px-6 opacity-0"
                >
                ...
                <div className="absolute inset-0 flex items-center justify-center w-full px-6">
                    ...
                    <div
                        ref={el => endingRefs.current[0] = el}
                    ...
                    <div
                        ref={el => endingRefs.current[1] = el}
                        className="absolute opacity-0"
                    >
                        <h2 className="font-serif text-3xl md:text-5xl text-cream font-light text-shadow">
                    ...
                    <div
                        ref={el => endingRefs.current[2] = el}
                        className="absolute opacity-0"
                    >
                    ...
                    <div
                        ref={el => endingRefs.current[3] = el}
                        className="absolute opacity-0 flex flex-col items-center gap-6"
                    >
                        ...
                        <h3 className="font-sans text-xl md:text-2xl text-cream/70 font-light tracking-widest uppercase">
                            ...
                            <span className="text-white font-medium block mt-2 text-2xl md:text-3xl normal-case font-serif">
                                {CONFIG.MY_NAME}
                            </span>
                        </h3>
                    </div>
